...
public class HandlerUsuarios {
	...
	private HandlerUsuarios() {
		...
		Usuario u2 = new Usuario("waston", "Carlos2", "Garcia2", "carlosgarcia@gmail.com", LocalDate.now());
		Usuario u3 = new Artista("lospimpi", "Carlos3", "Garcia3", "carlosgarcia@gmail.com", LocalDate.now(),"hola", "hola", "hola");
