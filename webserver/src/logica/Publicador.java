...
public interface Publicador {
    ...
    @WebMethod
    @WebResult(partName = "return")
    @Action(input = "http://logica/Publicador/existeUsuarioRequest", output = "http://logica/Publicador/existeUsuarioResponse")
    ...
    @WebMethod
    @WebResult(partName = "return")
    @Action(input = "http://logica/Publicador/existeEmailRequest", output = "http://logica/Publicador/existeEmailResponse")
